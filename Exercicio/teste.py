...
print('------ABSOLUTE------')
print(np.absolute(array_1))  # valores absolutos, não considera negativos
# valores negativos são convertidos para positivos
...
# 1 / array_1
# valor reciproco exemplo: x * y = 1 (y é o valor reciproco de x)
print('------------')
